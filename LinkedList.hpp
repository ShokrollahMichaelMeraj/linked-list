...
{
private:
  Node* head; // keep head private for Object oriented programing.

public:
    LinkedList(); // constructor
    ~LinkedList(); // destructor
    Node * headAccess(); // return pointer to head
    ...
    int clear(); // clears out the entire list, then returns 1
    ...
    int findLength(Node * head); //find length of a list.  
